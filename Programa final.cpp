...
int main()
{
   mostrarDguardados();
    ...
    do {
        ...
        if (opcion <= 0 || opcion >= 7) { cout << "Opcion incorrecta";  system("pause"); system("cls"); }
...
void Alta() {
    ...
    do {
        ...
        if (vnume(entrada)) { cr = stoi(entrada); }
    ...
    for (i = 0; i < cr; i++) {
        ...
        do
        {
            ...
            do {
                ...
                cin >> entrada;
                if (vnume(entrada)) { dato[i].numero = stoi(entrada); }
                else { cout << "\nEscribe solo numeros"; }
        ...
        do {
            ...
            cin >> entrada;
            if (vnume(entrada)) { dato[i].Precio = stoi(entrada); }
            else { cout << "\nEscribe solo numeros"; }
...
void fecha() {
    do {
        printf("\nA%co:", 164);
        cin >> entrada;
        if (vnume(entrada)) { dato[i].ano = stoi(entrada); }
        else { cout << "\nEscribe solo numeros"; }

        if ((dato[i].ano < 1960 || dato[i].ano > 2023)) { cout << "\nError en el numero ingresado" << endl; system("pause"); }
    ...
    do {
        ...
        cout << "\nMes:";
        cin >> entrada;
        if (vnume(entrada)) { dato[i].mes = stoi(entrada); }
        else { cout << "\nEscribe solo numeros"; }
        if ((dato[i].mes <= 0 || dato[i].mes > 12)) { cout << "\nError en el numero ingresado" << endl; system("pause"); }
    ...
    case 12:
        do {
            cout << "\nDia: ";
            cin >> entrada;
            if (vnume(entrada)) { dato[i].dia = stoi(entrada); }
            else { cout << "\nEscribe solo numeros"; }
    ...
    case 11:
        do {
            ...
            if ((dato[i].dia <= 0 || dato[i].dia > 30)) { cout << "\nError en el numero ingresado" << endl; system("pause"); }
...
void modificar() {
    ...
    do
    {
        ...
        if (vnume(entrada)) { ndm = stoi(entrada); }
        else { cout << "\nEscribe solo numeros"; }
        ...
        if (q != 0) {
            ...
            cout << "\nError en el numero, ese numero no existe" << endl; system("pause");
        }
        */
    } while (ndm < 0);
        ...
        if (ndm == dato[k].numero) {
            ...
            case 1:
                ...
                do
                {
                    ...
                    if (vnume(entrada)) { dato[k].numero = stoi(entrada); }
                    else { cout << "\nEscribe solo numeros"; }
                    if (dato[k].numero < 0)
                    {
            ...
            case 9:
                do
                {
                    ...
                    if (vnume(entrada)) { dato[k].Precio = stoi(entrada); }
                    else { cout << "\nEscribe solo numeros"; }
                    if (dato[k].Precio < 0)
                    {
...
void fechan() {
    ...
    do {
        cout << "\nAno:";
        cin >> entrada;
        if (vnume(entrada)) { dato[k].ano = stoi(entrada); }
        else { cout << "\nEscribe solo numeros"; }

        if ((dato[k].ano < 1960 || dato[k].ano > 2023)) { cout << "\nError en el numero ingresado" << endl; system("pause"); }
    ...
    do {
        ...
        cout << "\nMes";
        cin >> entrada;
        if (vnume(entrada)) { dato[k].mes = stoi(entrada); }
        else { cout << "\nEscribe solo numeros"; }
        if ((dato[k].mes <= 0 || dato[k].mes > 12)) { cout << "\nError en el numero ingresado" << endl; system("pause"); }
    ...
    case 12:
        do {
            cout << "\nDia:";
            cin >> entrada;
            if (vnume(entrada)) { dato[k].dia = stoi(entrada); }
            else { cout << "\nEscribe solo numeros"; }
...
void Eliminar() {
    ...
    do
    {
        ...
        if (vnume(entrada)) { endm = stoi(entrada); }
        else { cout << "\nEscribe solo numeros"; }
        if (endm < 0) { cout << "\nError en el numero" << endl; system("pause"); }
